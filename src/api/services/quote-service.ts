...
export class QuoteService {
  ...
  /**
   * Get an ayah by its verse reference (e.g., "2:261")
   */
  getAyahByVerse(verse: string): Ayah | undefined {
    return this.ayahs.find((ayah) => ayah.verse === verse);
  }
  ...
  getHadithById(id: string): Hadith | undefined {
    return this.hadiths.find((hadith) => hadith.id === id);
  }
}
